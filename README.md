...
|---|---|---|
| [Article 1 — Concept and architecture](https://medium.com/) | `article-01-concept-and-architecture/` | Architecture overview, hardware BOM, software inventory |
| [Article 2 — Metrics server](https://medium.com/) | `article-02-metrics-server/` | InfluxDB, Node-RED, Mosquitto, Flux queries, context API |
| [Article 3 — Object store and annotation](https://medium.com/) | `article-03-object-store-annotation/` | MinIO, Label Studio, annotation project setup |
